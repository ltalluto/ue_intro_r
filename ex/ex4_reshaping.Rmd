...
3. Use `substr` to split of the measurement number from each of the velocity and depth measurements (i.e., you will have one column that says just "velocity" or "depth" and one that will say "01", "02", etc).
